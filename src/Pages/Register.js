        ...
        <div className="col-11 col-sm-10 col-md-5 register-card">
          ...
          <InputGroup>
            ...
            <Input type="select" name="role" onChange={(e)=> handleChange(e)}>
              ...
              {/* <option value="processing">Processing Unit Officer</option> */}
              <option value="manufacturer">Manufacturer</option>
              <option value="distributer">Distributor</option>
              <option value="retailer">Retailer</option>
              <option value="warehouse">Hotel Warehouse Manager</option>
              <option value="kitchen">Hotel Kitchen Chef</option>
